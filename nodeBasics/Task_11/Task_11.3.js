...
async function runRequests() {
	try {
		const results = await Promise.all([newRequest_UserPage_1(), newRequest_UserPage_2()]);
		...
		const first_request = await Promise.race([newRequest_UserPage_1(), newRequest_UserPage_2()]);
